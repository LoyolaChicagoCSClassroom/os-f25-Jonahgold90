...
BOOTIMG:=/usr/local/lib/grub/i386-pc/boot.img
GRUBLOC:=/usr/local/bin/
else
PREFIX:=
...
CFLAGS := -ffreestanding -mgeneral-regs-only -mno-mmx -m32 -march=i386 -fno-pie -fno-stack-protector -g3 -Wall -Iinclude
